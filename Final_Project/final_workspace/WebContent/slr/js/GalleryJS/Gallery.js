 ...
 * 
 */
// url = "mainSlr.jsp?cosntent=TopContents/Gallery/Write/";
// url = "semi2joMain.jsp?content=TopMenu/team_view.jsp&rno="+rno;//parameter를
// 연결하기위해 '&'를 쓴다.
// Write//
// 작성완료 버튼
function GallWrite() {
	document.getElementById('comment_write').onclick = function() {
		alert("df");
		url = "mainSlr.jsp?content=TopContents/Gallery/Write/Gallery_Comment_write_result.jsp";
...
function write_btn3() {
	alert("입력");
	url = "mainSlr.jsp?content=TopContents/Gallery/Write/Galleryt_write_result.jsp";
	frm_insert.action = url;
	frm_insert.submit();
}
...
function goview(frno) {
	url = "mainSlr.jsp?content=TopContents/Gallery/View/Gallery_View.jsp&frno="
			+ frno;
	location.href = url;
}
