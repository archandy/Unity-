...
<script>
function init(){
	location href="mainSlr.jsp?content=TopContents/Market/market_write2.jsp";
...
<div id='info_body_wrap'>
    ...
    <div id='info_mid_all'>
        ...
        <div id='info_mid_board'>
            ...
            <a href='mainSlr.jsp?content=TopContents/Market/market_write7.jsp' id='info_mid_title'>
        ...
        <div id='info_bot'>
            ...
            <img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>1</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>2</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>3</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>4</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>5</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>6</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>7</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>8</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>9</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>10</font></a><img class='pg_divide' src='img/list_num_vline2.gif'>
            ...
            <form action="" name="write_frm" method="post">
                <input type="button" value="글쓰기" class='info_bot_btn' onClick="location.href='mainSlr.jsp?content=TopContents/Market/market_write9.jsp'">
            </form>
            </div>
