...
<div id='info_body_wrap'>
    ...
    <div id='info_mid_all'>
        ...
        <div id='info_mid_board'>
            ...
            <a href='mainSlr.jsp?content=TopContents/Market/market_write3.jsp' id='info_mid_title'>
        ...
        <div id='info_bot'>
            ...
            <form action="" name="write_frm" method="post">
                <input type="button" value="글쓰기" class='info_bot_btn' onClick="location.href='mainSlr.jsp?content=TopContents/Market/market_write2.jsp'">
            </form>
            </div>
