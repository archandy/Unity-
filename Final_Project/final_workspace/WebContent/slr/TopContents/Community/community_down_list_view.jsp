...
<%
	...
	String sideMenu = "community_menu_jsp/side_community3.jsp";
	String tabMenu = "community_main_top_Down_jsp/top_community_Down_c1.jsp";
	String rightContent = "community_main_free_jsp/community_free_view.jsp";
	String comment	=	"community_main_free_jsp/community_free_comment_close.jsp";
