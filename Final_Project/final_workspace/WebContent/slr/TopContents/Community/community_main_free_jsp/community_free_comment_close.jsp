...
<title>Comment</title>
<link rel='stylesheet' href='TopContents/Community/community_main_free_jsp/css/community_comment.css' type='text/css'>
</head>
<body>
	<div class="slr_comment">
		...
		<div class="slr_comment_open">
			...
			개의	댓글이 있습니다.</span> 
			<span id="slr_comment_close"> <img alt="댓글닫기" src="imgs/Community/bt_cmt_close.gif" width="76" height="12"  style="vertical-align: middle" /></span>
			</div>
			</div>	
	...
	<div class="comment_bottom_btns">
		...
		<div class="btn1">
				<img src="imgs/Community/bt_scrap.gif" width="63" height="26" alt="스크랩" />
				<img src="imgs/Community/bt_recmd.gif" width="63" height="26" alt="추천하기" />
				<img src="imgs/Community/bt_admin.gif" width="63" height="26" alt="관리요청" />
		</div>
		
		<div class="btn2">
			<img src="imgs/Community/bt_reply.gif" width="63" height="26" alt="답글쓰기" />
			<img src='imgs/Community/Gul.gif'width="63" height="26" alt="글쓰기" />
			<img src="imgs/Community/bt_list.gif" width="63" height="26" alt="목록보기" />
		</div>
