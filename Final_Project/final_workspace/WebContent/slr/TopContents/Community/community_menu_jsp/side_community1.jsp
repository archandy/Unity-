...
<div id="side_wrap">
	<div id="info_side_community">
		<a id="a_slr" href='mainSlr.jsp?content=TopContents/Community/community_free_list.jsp'><font id="slr">자유게시판</font></a>
	</div>
	<div id="info_side_photo">
		<font ><a id="b_slr" href='mainSlr.jsp?content=TopContents/Community/community_photo_list.jsp'>포토스트림</a></font>
	</div>
	<div id="info_side_down">
		<font ><a id="c_slr" href='mainSlr.jsp?content=TopContents/Community/community_menu_jsp/side_community3.jsp'>자료실</a></font>
	</div>
	<div id="info_side_adult">
		<font ><a id="d_slr" href='mainSlr.jsp?content=TopContents/Community/community_menu_jsp/side_community4.jsp'>성인게시판</a></font>
	</div>
</div>
</body>
</html>