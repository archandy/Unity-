...
<div id='info_body_wrap'>
    ...
    <div id='info_mid_all'>
        ...
        <div id='info_bot'>
            ...
            <img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>1</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>2</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>3</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>4</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>5</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>6</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>7</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>8</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>9</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            <a href='#' class='pg_num'><font class='pg_divide'>10</font></a><img class='pg_divide' src='../imgs/list_num_vline2.gif'>
            ...
            <div class='info_bot1' id='info_bot_btn4'>
                <input type="button" value="새로고침" class='info_bot_btn'>
            </div>
        </div>
    </div>
        <div id='info_bot2'>
