...
<body>
	...
	<div id = 'comment_ID'>
		<div id='comment_ID1'>
			<div id='comment_getID2'></div>
			<div id ='comment_getID'>아이디</div>
			<div id ='comment_getData'>2015-06-15 20:38:20</div>
			<div id ='comment_HP'>추천 | 신고</div>
			<div id ='comment_gettext'>내용</div>
			<div id ='comment_comment'>댓글의 댓글▼</div>
		</div>
	...
	<div class="comment_bottom_btns">
		...
		<div class="btn1">
				...
				<img src="../imgs/bt_recmd.gif" width="63" height="26" alt="추천하기" />
				<img src="../imgs/bt_admin.gif" width="63" height="26" alt="관리요청" />
		</div>
