...
<body>
	...
	%>
	<div id='mall_left_menu'>
<%-- 		<% --%>
<!-- // 			if (id.equals(data.getId())) { -->
<%-- 		%> --%>
<!-- 		<div id='mall_member_my'>비회원</div> -->
<!-- 		<div id='mall_member_id'></div> -->
<!-- 		<div id='mall_member_level'></div> -->
<!-- 		<div id='mall_member_point'></div> -->
<!-- 		<div id='mall_member_licence'></div> -->
<%-- 		<% --%>
<!-- // 			} else { -->
<%-- 		%> --%>
		<div id='mall_member_my'>내정보</div>
		<div id='mall_member_id'>닉네임 <font color='#199900'><%=data.getNick()%></font></div>
		<div id='mall_member_level'>
			레벨 <font color='#199900'><%=data.getNow_level()%></font>
		</div>
		<div id='mall_member_point'>
			포인트 <font color='#199900'><%=data.getPoint()%></font>
		</div>
		<div id='mall_member_licence'>
...
<%-- 		%> --%>
		...
		<a href='mainSlr.jsp?content=TopContents/mall/main_buy.jsp'>
			<div id='mall_item_buy_btn'>아이템 구매</div>
		</a> <a href='mainSlr.jsp?content=TopContents/mall/main_inven.jsp'>
			<div id='mall_inventory'>인벤토리</div>
		</a>
	</div>
</body>
</html>