                    ...
                    <div id="list">
                        ...
                        <div id="list_gesi">
                            ...
                            <div id="list_title">
                                <font class="gesi_text" id="gesi_title">
                                    <a class="list_a" href="mainSlr.jsp?content=TopContents/Information/gesipan_view.html">[1] SLR리뷰 운영 안내</a>
                        ...
                        <div id="list_bot">
                            ...
                            <div id="btn_right">
                                ...
                                <div id="write_btn"><a href="mainSlr.jsp?content=TopContents/Information/SlrReview/info_write_slr.jsp" id="write_page">글쓰기</a></div>
                            </div>
                        </div>
